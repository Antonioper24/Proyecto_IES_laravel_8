        	...
        	<div>
		      <blockquote class="formu">
                	...
                	@csrf
                		...
                		<input class="texto1"  type="text" name="id" value="{{$datos->num_expe}}" required>
                		<br>
                		<br>
                		<label for="nombre">Nombre</label>&nbsp;
                		<input class="texto2"  type="text" name="nombre" value="{{$datos->nombre}} {{$datos->apellido1}}">
                		<br>
                		<br>
						<label for="radio">Nueva Radiogr&aacute;fia</label>
                		<input class="texto3"  type="text" name="radio" value="{{$datos->num_radiogra}}" required>
						<br>
						<br>
                		<label for="tratami">Tratamiento</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                		<input class="texto"  type="text" name="tratami" value="{{$datos->tratamiento}}" required>
                		<br>
                		<br>
